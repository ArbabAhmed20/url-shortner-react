...
const Login = () => {
    ...
    const loginHandler = async (data) =>{
        ...
        //Storing Token in the Browser local storage.
    ...
    return (
        <div>
            <div className={"min-h-[calc(100vh-64px)] flex justify-center items-center"}>
                <form onSubmit={handleSubmit(loginHandler)} className={"sm:w-112.5 w-90  shadow-[0_0_15px_rgba(0,0,0,0.3)] py-8 sm:px-8 px-4 rounded-md"}>
